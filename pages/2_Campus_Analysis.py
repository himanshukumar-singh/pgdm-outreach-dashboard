...
.campus-insight {
    ...
    margin-bottom: .48rem;
    animation: campusInsightFloat 4.0s ease-in-out infinite;
    transition:
        transform .22s ease,
        box-shadow .22s ease,
...
.campus-insight::before {
    ...
    animation: campusInsightSheen 5.8s ease-in-out infinite;
}

.campus-insight:hover {
...
.campus-insight .label {
    ...
    animation: campusInsightTitleFlow 6.2s linear infinite;
}
...
.campus-action {
    ...
    animation: campusInsightFloat 4.1s ease-in-out infinite;
    transition:
        transform .22s ease,
        box-shadow .22s ease;
}
...
.campus-action::after {
    ...
    transform: skewX(-18deg);
    animation: campusInsightSheen 6.0s ease-in-out infinite;
}
...
.campus-action .title {
    ...
    background-clip: text;
    -webkit-text-fill-color: transparent;
    animation: campusInsightTitleFlow 6s linear infinite;
}
...
@keyframes campusInsightTitleFlow {
    0% {
